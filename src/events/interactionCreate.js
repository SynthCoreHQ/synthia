...
export default class InteractionCreateEvent extends Event {
    ...
    async execute(client, interaction) {
        if (interaction.isModalSubmit()) {
            ...
            await client.guild_data.set(interaction.guildId, { prefix });
        ...
        //     try {
        //         const command = client.interactions.get(interaction.commandName); // eslint-disable-line max-len
        ...
        //         if (this.discordClient.cooldown(command, interaction.user)) {
        //             return await interaction.reply({
        //                 embeds: [
        //                     {
        //                         description: `You are on cooldown! Please wait ${this.discordClient.cooldown(command, interaction.user)} seconds before using this command again.`,
        //                         color: client.config.embeds.color,
        //                     },
        //                 ],
        //             });
        ...
        //     const command = this.discordClient.interactionCommands.get(interaction.commandName);
